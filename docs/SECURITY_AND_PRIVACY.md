...
Docker isolation reduces host exposure but is not VM-grade isolation. DoneWitness trusts Docker,
...
Submodules/gitlinks are rejected, and DoneWitness never fetches, pulls, or clones.
...
DoneWitness does not automatically upload verification evidence to CI artifacts.
...
DoneWitness does not make a shared privileged runner safe.
